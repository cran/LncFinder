#' A demo of dataset
#'
#' This dataset contains the features of 20 lncRNA sequences and 20 protein-coding
#' sequences.
#'
#' @name demo_dataset
#' @usage data(demo_dataset)
...
#' }
#' @source DNA sequences are selected from GENCODE. Secondary structure of each
